...
<main class="container">
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p>
                    <a href="${pageContext.request.contextPath}/OrganizationServlet?command=LIST" class="btn btn-primary my-2">Get back to organization</a>
                </p>
            </div>
        </div>
    </section>
    <form class="row" action="OrganizationServlet" method="post">
        <div class="col-3"></div>
        <div class="col-6">
            <input type="hidden" name="manager_id" value="12"/>
